...
# language: en
Feature: Tạo đơn hàng Internet book port bằng tay

	Scenario Outline: Tạo đơn hàng Internet book port bằng tay
		...
		And Nhấn xác nhận
		And Truy cập màn hình chi tiết
		And Nhấn xác nhận
		...
		Then Kiểm tra thông tin thanh toán
